...
- **OpenSSL** 3.0+ for AES-256-GCM (EVP) used by the ML-KEM transport
...
|-----------|---------------------------------------------------|---------|------------------------|
| OpenSSL   | AES-256-GCM (EVP) for the ML-KEM transport        | 3.0     | 3.6.3                  |
